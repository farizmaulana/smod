...
<html>
    <head>
        ...
        <link rel=\"stylesheet\" href=\"<?php echo base_url('assets/AdminLTE/bower_components/datatables.net-bs/css/dataTables.bootstrap.css') ?>\"/>
        <style>
            .dataTables_wrapper {
                min-height: 500px
            }
...
$string .= "\n\t    
        ...
        <script src=\"<?php echo base_url('assets/AdminLTE/bower_components/datatables.net-bs/js/dataTables.bootstrap.js') ?>\"></script>
